package com.ibrohim.new_social_share.new_social_share
...
class SocialSharePlugin:FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, "new_social_share")
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
        ...
        if (call.method == "shareInstagramStory" || call.method == "shareFacebookStory") {
            ...
            val stickerImageFile = FileProvider.getUriForFile(activeContext!!, activeContext!!.applicationContext.packageName + ".com.ibrohim.new_social_share.new_social_share", file)
            ...
            if (backgroundImage!=null) {
                ...
                val backgroundImageFile = FileProvider.getUriForFile(activeContext!!, activeContext!!.applicationContext.packageName + ".com.ibrohim.new_social_share.new_social_share", backfile)
            ...
            if (backgroundVideo!=null) {
                ...
                val backgroundVideoFile = FileProvider.getUriForFile(activeContext!!, activeContext!!.applicationContext.packageName + ".com.ibrohim.new_social_share.new_social_share", backfile)
            ...
            if (image!=null) {
                ...
                val imageFileUri = FileProvider.getUriForFile(activeContext!!, activeContext!!.applicationContext.packageName + ".com.ibrohim.new_social_share.new_social_share", imagefile)
                intent.type = "image/*"
